...
**Validation:** `VAL-028`.
**Current evidence:** `BR-20260923-01` weekly recurrence/timezone/pause and `BR-20260923-02` skip/reschedule/restore are published through PR #28/#29. `BR-20260923-03` optional in-app reminders were subsequently published through exact reminder head `036f1ec5afa6aa9159cc0010b92a260937242a13` (CI #55 successful) and PR #30 merge `b50d92ca13a4bca2b19a9a0e2209a7b636ddf28c`. `BR-20260924-01` records the next locally verified review-only progression prerequisite: explicit difficulty/discomfort/requested reduction maps to a bounded, displayed pause or chosen-weekday reduction suggestion pinned to exact source versions; propose/dismiss events remain immutable, owner-private and exportable in v10. Focused progression pgTAP 25/25; 18/18 authenticated browser flows; lint (two warnings), typecheck, 21/21 unit tests and production build passed. Full preserved-volume pgTAP 366/366 and database lint passed after fixture-scoping three legacy schedule lifecycle assertions. Clean migration/seed replay with the new progression migration and remote exact-head CI/merge remain unproven. No automatic application, true reversal, missed-session handling or background reminder delivery is claimed; PH-05 and `VAL-028` remain partial.
